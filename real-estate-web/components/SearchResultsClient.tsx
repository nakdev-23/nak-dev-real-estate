...
export default function SearchResultsClient({ searchParams }: SearchResultsClientProps) {
  ...
  useEffect(() => {
    ...
    const results = searchProperties(mockProperties, criteria);
    ...
    setLoading(false);
  }, [type, location, minPrice, maxPrice, propertyType, bedrooms, bathrooms, minArea, sortBy]);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">{t("search")}</h1>
